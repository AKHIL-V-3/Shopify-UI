...
export const Header = () => {
    return (
        <>
            <div className="bg-black flex h-14 w-full sticky top-0">
                ...
                <div className="w-1/2 h-full flex justify-center items-center">
                    <div className="bg-zinc-800 text-opacity-70 text-white border border-white  border-opacity-20 rounded-lg px-2 w-7/12 h-10/12 flex justify-center items-center">
                        <IconSearch />
